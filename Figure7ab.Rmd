...
## Figure 7.ab) PCA 1 versus 2 and PCA 1 versus 3. The inset (far left) shows all cells coloured by cell surface phenotype. Red dots show the position of cells that are Cd4+Cd8a+ (left), Cd4+Cd8a- (centre), or Cd4- Cd8a+ (right). 
...
Rep1_filtered_rep2@meta.data$Cd4Cd8 <- "Other"
Rep1_filtered_rep2@meta.data[Rep1_filtered_rep2@meta.data$Cd4=='Cd4+' & Rep1_filtered_rep2@meta.data$Cd8=='Cd8+','Cd4Cd8'] <- "Cd4+Cd8+"
DimPlot(Rep1_filtered_rep2, reduction = "pca", group.by = "Cd4Cd8", cols=c('red','gray'), dims=c(1,3))
