...
#                 ,])
 ...
 # variable_genes <- noquote(variable_genes)
...
#                 ,]))
# 
# Rep1_filtered_rep2KO_cells <- rownames(meta_info[
#          ((meta_info$rep=='rep2_KO' & meta_info$celltype=='CD69posDP' & meta_info$nCount_RNA < 1500000 & meta_info$nCount_RNA > 750000) |
#          (meta_info$rep=='rep2_KO' & meta_info$celltype!='CD69posDP' & meta_info$nCount_RNA < 1500000 & meta_info$nCount_RNA > 500000)) 
#                 ,])
...
## Figure7.e) Slingshot trajectory of wild-type Cd4+ Cd8a+, Cd4+ Cd8a-, Cd4- Cd8a+ selection intermediates based on PCA clustering (top), pseudotime analysis (middle) and quantification of co-receptor gene expression patterns along the pseudotime axis (bottom). 
...
meta$pseudotime_range <- "0_to_10"
meta[meta$pseudotime > 10 & meta$pseudotime < 20, "pseudotime_range" ] <- "10_to_20"
meta[meta$pseudotime > 20 & meta$pseudotime < 30, "pseudotime_range" ] <- "20_to_30"

A1 <- table(meta[meta$pseudotime_range=="0_to_10",'Cd4Cd8'])
A2 <- table(meta[meta$pseudotime_range=="10_to_20",'Cd4Cd8'])
A3 <- table(meta[meta$pseudotime_range=="20_to_30",'Cd4Cd8'])

A <- as.data.frame(c(A1,A2,A3))
colnames(A) <- ' cell_counts'
A$pseudotime_range <- c("0_to_10","0_to_10","0_to_10","10_to_20","10_to_20","10_to_20","20_to_30","20_to_30","20_to_30")
