---
title: "Gene expression by individual selection of known Cd4 and Cd8a co-receptor gene expression status (Figure 4, Sup Figure 2a, and Sup Figure 5)"
author: "Mehdi Karimi"
date: "11/04/2020"
output: 
  html_document:
...
## Supplementary Figure 2a) Heatmap of key genes. See Supplementary Table 3 for an analysis of differential gene expression between sorted thymocyte subsets.
...
genes <- c('Rag1','Rag2','Dntt','Myb','Cd24a',
           'Myc', 'Ccr7', 'Il7r', 'B2m', 'H2-K1', 'H2-D1', 
           'Cd69', 'Cd5', 'Cd28', 'Tox', 'Itm2a', 
           'Itgae','Cst7', 'Nkg7', 'Cxxc5', 'Dtx1', 
           'Cd40lg', 'Itgb3', 
           'Zbtb7b', 'Runx3', 'Runx1', 'Gata3', 
           'Stat5a', 'Stat5b', 'Stat6', 'Socs1')

Idents(Rep1_filtered_rep2) <- 'celltype'

Rep1_filtered_rep2 <- ScaleData(Rep1_filtered_rep2, verbose = FALSE)
levels(Rep1_filtered_rep2) <- c("CD69negDP", "CD69posDP", "TCRhiDP", "CD4+8low","CD4SP_Immature","CD4SP_Mature","CD8SP")
...
Rep1_filtered_rep2@meta.data[(Rep1_filtered_rep2@meta.data$celltype=="CD69posDP" | Rep1_filtered_rep2@meta.data$celltype=="TCRhiDP" | Rep1_filtered_rep2@meta.data$celltype=="CD4+8low") &
                               Rep1_filtered_rep2@meta.data$Cd4Cd8=='Cd4+Cd8+','celltype'] <- 'Cd4+Cd8+'
...
genes <- c('Rag1','Rag2','Dntt','Myb','Cd24a',
           ...
           'Cd69', 'Cd5', 'Cd28', 'Tox', 'Itm2a',
           'Stat5a', 'Stat5b', 'Stat6', 'Socs1',
           'Itgae','Cst7', 'Nkg7', 'Runx3', 
           'Cd40lg', 'Itgb3', 
           'Zbtb7b', 'Cd4', 'Cd8a', 'Cd8b1'
           )
...
Rep1_filtered_rep2 <- ScaleData(Rep1_filtered_rep2, verbose = FALSE)
levels(Rep1_filtered_rep2) <- c("CD69negDP", 'Cd4+Cd8+', 'Cd4+Cd8-', 'Cd4-Cd8+', 'Cd4-Cd8-',"CD4SP_Immature","CD4SP_Mature","CD8SP")
