---
title: "Sup Figure 3.abcde and Sup figure 8"
author: "Mehdi Karimi"
date: "30/04/2020"
output: 
  html_document:
...
## Sup Figure 3.abcde and Sup Figure 8
...
data_scatter$celltype <- "NA"
data_scatter$celltype <- Rep1_filtered_rep2@meta.data[rownames(data_scatter),'celltype']

draw_ScatterPlot <-  function(pair){
sp <- ggscatter(data_scatter, x = pair[1], y = pair[2], color ='celltype', 
...
draw_ScatterPlot(c("Nkg7","Zbtb7b"))
draw_ScatterPlot(c("Cd8a","Zbtb7b"))
draw_ScatterPlot(c("Runx3","Cd4"))
draw_ScatterPlot(c("Runx3","Zbtb7b"))
draw_ScatterPlot(c("Cd8a","Cd8b1"))
draw_ScatterPlot(c("Itm2a","Zbtb7b"))
draw_ScatterPlot(c("Itm2a","Cd40lg"))
draw_ScatterPlot(c("Itm2a","Nkg7"))
draw_ScatterPlot(c("Itm2a","Itgae"))
