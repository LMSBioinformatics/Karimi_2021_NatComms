...
colnames(meta_info) <- c("rep", "celltype", "Cd4+Cd8+","Cd4+Cd8-", "Cd4-Cd8+", "Cd4-Cd8-", 'Cd8', 'Cd4', 'Itm2a', 'Stat1', "Zbtb7b+Runx3+") 
...
# CD4_8low <- subset(Rep1_filtered_rep2, cells = rownames(meta_info[meta_info$celltype=='CD4+8low',]))
# CD69negDP <- subset(Rep1_filtered_rep2, cells = rownames(meta_info[meta_info$celltype=='CD69negDP',]))
# CD4SP_Mature <- subset(Rep1_filtered_rep2, cells = rownames(meta_info[meta_info$celltype=='CD4SP_Mature',]))
# CD4SP_Immature <- subset(Rep1_filtered_rep2, cells = rownames(meta_info[meta_info$celltype=='CD4SP_Immature',]))
# 
# DimPlot(CD4_8low, reduction = "pca", group.by = "rep", cols=c('red','blue','green'))+xlim(-10,15)+ylim(-10,10)+ggtitle('CD4+8low')
# DimPlot(CD69negDP, reduction = "pca", group.by = "rep", cols=c('red','blue','green'))+xlim(-10,15)+ylim(-10,10)+ggtitle('CD69negDP')
# DimPlot(CD4SP_Mature, reduction = "pca", group.by = "rep", cols=c('red','blue','green'))+xlim(-10,15)+ylim(-10,10)+ggtitle('CD4SP_Mature')
# DimPlot(CD4SP_Immature, reduction = "pca", group.by = "rep", cols=c('red','blue','green'))+xlim(-10,15)+ylim(-10,10)+ggtitle('CD4SP_Immature')
# 
# 
# DimPlot(CD4_8low, reduction = "pca", group.by = "rep", cols=c('red','blue','green'), dims = c(1, 3))+xlim(-10,15)+ylim(-10,10)+ggtitle('CD4+8low')
# DimPlot(CD69negDP, reduction = "pca", group.by = "rep", cols=c('red','blue','green'), dims = c(1, 3))+xlim(-10,15)+ylim(-10,10)+ggtitle('CD69negDP')
# DimPlot(CD4SP_Mature, reduction = "pca", group.by = "rep", cols=c('red','blue','green'), dims = c(1, 3))+xlim(-10,15)+ylim(-10,10)+ggtitle('CD4SP_Mature')
# DimPlot(CD4SP_Immature, reduction = "pca", group.by = "rep", cols=c('red','blue','green'), dims = c(1, 3))+xlim(-10,15)+ylim(-10,10)+ggtitle('CD4SP_Immature')
...
####
Rep1_filtered_rep2 <- subset(WT_Thymocye.integrated, cells = rownames(meta_info[meta_info$Zbtb7b.Runx3.=="Zbtb7b+Runx3+" &
         ((meta_info$rep=='rep2' & meta_info$celltype=='CD69posDP' & meta_info$nCount_RNA < 1500000 & meta_info$nCount_RNA > 750000) |
         (meta_info$rep=='rep2' & meta_info$celltype!='CD69posDP' & meta_info$nCount_RNA < 1500000 & meta_info$nCount_RNA > 500000)) 
                ,]))
...
draw_ScatterPlot(data_scatter, c("Cd4","Cd8a"), 'Zbtb7b+Runx3+')
####
